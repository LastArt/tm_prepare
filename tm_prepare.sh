...
function print_logo() {
    ...
    echo "  / / / / __ \`__ \/ _ \     / // __ \/ ___/ __ \/ _ \/ ___/ __/ __ \/ ___/"  # Экранирована обратная кавычка:
...
function post_subscript_menu() {
    echo -e "\n${YELLOW}Нажмите [M или m] для возврата в главное меню или [E или e] для выхода из программы.${NC}"
...
function main_menu() {
    while true; do
        clear
        print_logo  # Вывод логотипа всегда сверху
        echo -e "${BLUE}************************************************************************${NC}"
