...
##############################################
# 5. Функция настройки датчика движения – заглушка
##############################################
function setup_motion_sensor() {
    echo -e "\n${YELLOW}🚨 Настройка датчика движения в разработке...${NC}"
    post_subscript_menu
}
...
function post_subscript_menu() {
    echo -e "\n${YELLOW}Нажмите (M) для возврата в главное меню или (E) для выхода из программы.${NC}"
